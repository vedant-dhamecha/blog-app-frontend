...
const CTA = () => {
  return (
    <>
      ...
      <section className="relative bg-dark-blue px-5">
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            <h2 className="text-white font-Roboto font-bold text-2xl md:text-4xl md:text-center md:leading-normallg:text-left">
          ...
          <div className="col-span-12 hidden mb-[70px] md:block md:order-first lg:col-span-6 lg:order-last">
            <div className="w-3/4 mx-auto relative ">
              ...
              <div className="w-full rounded-xl bg-white p-3 z-[1] relative ">
                ...
                />
                <div className="p-5">
                  <h2 className="font-Roboto font-bold font-xl text-black md:text-2xl lg:text-[28px]">
                    Future of work
                  </h2>
