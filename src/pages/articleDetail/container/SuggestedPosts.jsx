...
const SuggestedPosts = ({ className, header, posts = [], tags }) => {
  return (
    ...
    >
      <h2 className="font-roboto font-medium text-dark-blue md:text-xl">
        {header}
      </h2>
        ...
        {posts.map((item) => (
          ...
          >
            <img
              ...
              alt={item.title}
            />
            <div className="text-sm font-roboto text-dark-blue font-bold">
              <h3 className="text-sm font-roboto text-dark-blue font-medium md:text-base lg:text-lg">
      ...
      <h2 className="font-roboto font-medium text-dark-blue mt-8 md:text-xl">
        Tags
      </h2>
      {tags.length === 0 ? (
