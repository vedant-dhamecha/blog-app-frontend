    ...
    <li className="relative group">
      {item.type === "link" ? (
        ...
        <div className="flex flex-col items-center">
          ...
          >
            <ul className="bg-light-pink dark:bg-[#9aa9b4] lg:bg-transparent text-center flex flex-col shadow-lg rounded-lg overflow-hidden">
...
const Header = ({isDarkMode}) => {
  ...
  return (
    <section className="sticky top-0 left-0 right-0 z-50 bg-white shadow-lg dark:bg-[#101010]">
      <header className="container mx-auto px-5 flex justify-between py-4 items-center">
        ...
        <div
          ...
          } transition-all duration-300 mt-[56px] lg:mt-0 bg-dark-hard dark:bg-[#101010] lg:bg-transparent z-[49] flex flex-col w-full lg:w-auto justify-center lg:justify-end lg:flex-row fixed top-0 bottom-0 lg:static gap-x-9 items-center`}
        >
